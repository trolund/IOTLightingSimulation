    ...
    public void receiveEvent(Event event) {
        switch (event.getEventType()) {
            ...
            case "TokenValidationFailed":
                ...
                desc = "Transaction between Customer (Id: " + customerId + ") " +
                        " (BankId: " + customerBankId + ")" +
                        " and Merchant (Id: " + merchantId + ")" +
                        " (BankId: " + merchantBankId + " for amount " + amount +
                        " with token " + token;

                dto = new TransactionDTO(BigDecimal.valueOf(amount), paymentAccounts.getCustomer().getBankAccount().getBalance(), merchantId, customerId, desc, new Date(), false);
