Feature: Bank accounts
    ...
    Scenario: Creating a duplicate bank account
        ...
        And: an exception is thrown with the error message from the response
    ...
    Scenario: Fetching a bank account by CPR number
        ...
        Then: the account details are retrieved from the banking server
    ...
    Scenario: Deleting an non-existant bank account
